...
- Benchmark data contains 32 varied questions but still evaluates one synthetic checkout corpus; metrics demonstrate repeatability and behavior on that incident, not general incident-resolution accuracy.
